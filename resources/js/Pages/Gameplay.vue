    ...
    <div class="container mx-auto">
        <div v-if="!gameStarted">
            ...
            <p class="text-lg mb-6">
                ...
                of each scenario and impact your final score. 🧐
            </p>
            <p class="text-lg mb-6">
                The score of each scenario is based on the ethical implications
                of your choice, with -1 representing a negative outcome, 0
                representing a neutral outcome, and 1 representing a positive
                outcome. 🤔 Your goal is to achieve the highest possible score
                by making the most ethical decisions. 💯
            </p>
            <p class="text-lg mb-6">
            ...
            <p class="text-lg mb-6">
                The result is a game that explores the complexities of ethical
                decision-making in a world increasingly driven by artificial
                intelligence. 🚀🌎🤖
            </p>
            <button
